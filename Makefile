...
form_view:cgi/form_view.c $(DB_SRC)
	$(CC) $(CFLAGS) -o $@ cgi/form_view.c $(DB_SRC) $(MYSQL_FLAGS)

edit_form:cgi/edit_form.c $(DB_SRC)
	$(CC) $(CFLAGS) -o $@ cgi/edit_form.c $(DB_SRC) $(MYSQL_FLAGS)
